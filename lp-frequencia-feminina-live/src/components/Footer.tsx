export default function Footer() {
  return (
    <footer className="bg-carvao px-6 py-12 text-center md:px-12">
      <p className="mx-auto max-w-xl font-sans text-xs tracking-wide leading-relaxed text-champagne/45">
        Este conteúdo é educativo e não substitui consulta médica.
        <br />
        Dra. Josiane Canali | CRM PR 40.088 | RQE 4.382
      </p>

      <div className="mt-5 flex items-center justify-center gap-3 font-sans text-xs font-medium uppercase tracking-wide text-champagne/40">
