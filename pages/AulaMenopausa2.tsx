...
// Encolhe as duas linhas do título com base na largura real do container.
    ...
    return (
        <div className="w-full font-sans bg-stone-50">
            <SEO
                ...
                url="https://www.josianecanali.com.br/aula-menopausa-2"
            ...
            <section className="relative px-4 pt-[2.8rem] pb-14 overflow-hidden bg-gradient-to-b from-rose-50 via-stone-50 to-stone-50">
                ...
                <div className="relative z-10 max-w-3xl mx-auto w-full text-center flex flex-col items-center">
                    ...
                    <p className="text-stone-600 text-lg max-w-xl mb-10 leading-relaxed font-light">
                    ...
                    <div>
                        <CTAButton origin="aula-menopausa2-hero" />
            ...
            <section className="py-24 bg-stone-50">
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="text-center mt-14">
                        <CTAButton origin="aula-menopausa2-entenda" />
                    </div>
                </div>
            </section>
            ...
            <section className="bg-rose-400 py-24">
                <div className="max-w-3xl mx-auto px-4 text-center text-white">
                    ...
                    <CTAButton origin="aula-menopausa2-e-pra-voce" />
                </div>
            </section>
            ...
            <section className="py-24 bg-stone-50">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="text-center flex flex-col items-center">
                        ...
                        <CTAButton origin="aula-menopausa2-meio" />
